...
\resumeSubheading
  ...
  \resumeItemListStart
    \resumeItem{Stargate}{Created Docker and Kubernetes image and deployment manifest for a subset of the project and updated project to build in Linux environments.}
  \resumeItemListEnd
